...
var thousandsToRoman = input => // 1000 - 3000
rangeToRoman(input % 4, "M");

const range = top => Array.from({ length: top });

var rangeToRoman = (input, char) => range(input)
  .map((_) => char)
  .join("");
